...
<div class="row mb-4">
    ...
    <div class="col-md-6 mb-3">
        <a href="index.php?pg=transactions" class="text-decoration-none text-dark">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 mb-4">
            <a href="index.php?pg=myaccount" class="text-decoration-none">
        ...
        <div class="col-md-6 mb-4">
            <a href="index.php?pg=transactions" class="text-decoration-none">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <a href="index.php?pg=items" class="text-decoration-none">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
        ...
        <div class="col-md-6 mb-4">
            <a href="index.php?pg=categories" class="text-decoration-none">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
